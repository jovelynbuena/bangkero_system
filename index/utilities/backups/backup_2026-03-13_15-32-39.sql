-- Database Backup
-- Generated on: 2026-03-13 15:32:39
...
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('262', '321220', 'Logged in', NULL, '::1', '2026-03-13 20:05:56');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('263', '321220', 'Restored member: Cristopher M. De Jesus', 'Restored member: Cristopher M. De Jesus', NULL, '2026-03-13 20:38:33');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('264', '321220', 'Restored member: mew S meow', 'Restored member: mew S meow', NULL, '2026-03-13 20:38:40');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('265', '321220', 'Logged in', NULL, '::1', '2026-03-13 21:03:42');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('266', '321220', 'Logged in', NULL, '::1', '2026-03-13 21:18:01');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('267', '321212', 'Logged in', NULL, '::1', '2026-03-13 22:16:07');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('268', '321212', 'Logged in', NULL, '::1', '2026-03-13 22:19:19');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('269', '321220', 'Logged in', NULL, '::1', '2026-03-13 22:19:49');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('270', '321220', 'Database Backup', 'Created backup: backup_2026-03-13_15-30-49.sql', '::1', '2026-03-13 23:30:50');
INSERT INTO `activity_logs` (`id`, `user_id`, `action`, `description`, `ip_address`, `created_at`) VALUES ('271', '321220', 'Download Backup', 'Downloaded backup file: backup_2026-03-13_15-30-49.sql', '::1', '2026-03-13 23:30:51');
...
CREATE TABLE `announcements` (
  ...
  `posted_by` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'Admin',
  PRIMARY KEY (`id`),
...
CREATE TABLE `awards` (
  ...
  `description` text,
  `year_received` int DEFAULT NULL,
...
INSERT INTO `backups` (`id`, `filename`, `filesize`, `created_by`, `created_at`) VALUES ('22', 'backup_2026-03-13_15-30-49.sql', '157465', '321220', '2026-03-13 23:30:50');
...
CREATE TABLE `downloadable_resources` (
  `id` int NOT NULL AUTO_INCREMENT,
  `file_key` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `icon_class` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `color_hex` varchar(20) COLLATE utf8mb4_general_ci DEFAULT '#0d6efd',
  `sort_order` int NOT NULL DEFAULT '0',
...
CREATE TABLE `events` (
  `id` int NOT NULL AUTO_INCREMENT,
  `event_poster` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `events_archive` (
  ...
  `description` text COLLATE utf8mb4_general_ci,
  `event_poster` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'default.jpg',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `featured_programs` (
  ...
  `description` text COLLATE utf8mb4_general_ci NOT NULL,
  `icon_class` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `button_label` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'View Events',
...
CREATE TABLE `home_carousel_slides` (
  ...
  `primary_button_label` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'Learn More',
  `primary_button_link` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'about_us.php',
  `secondary_button_label` varchar(100) COLLATE utf8mb4_general_ci DEFAULT 'Join Us',
  `secondary_button_link` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'contact_us.php',
  `sort_order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
CREATE TABLE `member_archive` (
  ...
  `boat_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fishing_area` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `image` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'default_member.png',
...
CREATE TABLE `member_attendance` (
  ...
  `status` enum('present','absent','excused') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'present',
...
CREATE TABLE `members` (
  ...
  `membership_status` enum('active','inactive') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'active',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `dob` date DEFAULT NULL,
  `gender` enum('Male','Female','Other') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `civil_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `work_type` enum('Fisherman','Bangkero','Both') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `membership_type` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `license_number` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `municipal_permit_no` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bfar_fisherfolk_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `boat_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fishing_area` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `members` (`id`, `name`, `email`, `phone`, `address`, `street`, `barangay`, `municipality`, `province`, `region`, `zip_code`, `membership_status`, `created_at`, `dob`, `gender`, `civil_status`, `work_type`, `membership_type`, `license_number`, `municipal_permit_no`, `bfar_fisherfolk_id`, `boat_name`, `fishing_area`, `emergency_name`, `emergency_phone`, `agreement`, `image`) VALUES ('91', 'Cristopher M. De Jesus', 'dejesus@gmail.com', '098765434567', '', NULL, NULL, NULL, NULL, NULL, NULL, 'active', '2026-03-13 20:38:33', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, '', '', '', '', '0', 'default_member.png');
INSERT INTO `members` (`id`, `name`, `email`, `phone`, `address`, `street`, `barangay`, `municipality`, `province`, `region`, `zip_code`, `membership_status`, `created_at`, `dob`, `gender`, `civil_status`, `work_type`, `membership_type`, `license_number`, `municipal_permit_no`, `bfar_fisherfolk_id`, `boat_name`, `fishing_area`, `emergency_name`, `emergency_phone`, `agreement`, `image`) VALUES ('93', 'Grant Co Mccullough', 'zyto@mailinator.com', '0976-567-6567', 'Enim perferendis ess, Et aut rem labore el, Iste dolorum quibusd, Doloribus autem fuga, Region I 2290', 'Enim perferendis ess', 'Et aut rem labore el', 'Iste dolorum quibusd', 'Doloribus autem fuga', 'Region I', '2290', 'active', '2026-03-13 20:44:18', '1990-02-08', 'Female', 'Separated', 'Bangkero', NULL, '', '', '', '', NULL, 'Hakeem Vinson', '1587-543-2439', '1', 'default_member.png');
INSERT INTO `members` (`id`, `name`, `email`, `phone`, `address`, `street`, `barangay`, `municipality`, `province`, `region`, `zip_code`, `membership_status`, `created_at`, `dob`, `gender`, `civil_status`, `work_type`, `membership_type`, `license_number`, `municipal_permit_no`, `bfar_fisherfolk_id`, `boat_name`, `fishing_area`, `emergency_name`, `emergency_phone`, `agreement`, `image`) VALUES ('94', 'Maris Se Conway', 'ruwyh@mailinator.com', '1218-194-4283', 'Aut ex qui enim quae, Labore quis mollit r, Quae ipsam dolor opt, Deserunt sunt at con, Region XII 2290', 'Aut ex qui enim quae', 'Labore quis mollit r', 'Quae ipsam dolor opt', 'Deserunt sunt at con', 'Region XII', '2290', 'active', '2026-03-13 23:32:25', '2007-12-31', 'Female', 'Separated', 'Fisherman', NULL, '', '', '', '', NULL, 'Nadine Ayers', '1651-498-2261', '1', 'default_member.png');
...
CREATE TABLE `partners_sponsors` (
  ...
  `type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'partner',
  `sort_order` int NOT NULL DEFAULT '0',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `system_config` (
  `id` int NOT NULL,
  `assoc_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `assoc_email` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `assoc_phone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `assoc_address` text COLLATE utf8mb4_general_ci NOT NULL,
  `assoc_logo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `auto_backup_status` tinyint(1) NOT NULL DEFAULT '0',
  `backup_storage_limit_mb` int NOT NULL DEFAULT '100',
...
CREATE TABLE `transparency_beneficiaries` (
  ...
  `name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `household_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `assistance_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `category` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `amount_value` decimal(15,2) DEFAULT NULL,
  `quantity` int DEFAULT NULL,
  `date_assisted` date NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'served',
  `barangay` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `municipality` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `province` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `photo_path` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `short_story` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `transparency_campaigns` (
  ...
  `status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'planned',
...
CREATE TABLE `transparency_donations` (
  ...
  `donor_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `donor_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `amount` decimal(15,2) NOT NULL DEFAULT '0.00',
  `currency` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PHP',
  `date_received` date NOT NULL,
...
CREATE TABLE `transparency_impact_metrics` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `metric_key` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `calculation_mode` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'manual',
  `auto_source` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `transparency_settings` (
  ...
  `transparency_statement` text COLLATE utf8mb4_general_ci,
  `disclaimer_text` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `users` (
  ...
  `id` int NOT NULL AUTO_INCREMENT,
  `role` enum('admin','member','officer') COLLATE utf8mb4_general_ci NOT NULL,
  `transparency_role` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('argie2', '$2y$10$PXmeV0TETc4CasIO.PUGYe4s18MgWUyQOcwmCYDtimhT.By3nXXhC', '0', NULL, '321211', 'admin', NULL, 'approved', '2025-10-03 03:58:05', 'argie2@gmail.com', '096204334624', 'Male', 'bulacan, bulacan ', '1760856293_cybernetic-cool-anime-cyborg-girl-9y-1920x1080.jpg', 'argie', 'buena', NULL, '0', '9e549cf1b00a70ce599c39de648c429c3559cd215dd1abd1e59929c2898aa788', '2026-03-13 22:10:53');
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('jesus', '$2y$10$YxVNT7nlN08zHd.e.SK9/u7PJKxIevANrb5ySVXHEDyGqrKgmGIQy', '0', NULL, '321212', 'member', NULL, 'approved', '2025-10-03 20:21:05', 'dejesus@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, '77', '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('josemarichan', '$2y$10$eV5aMXWy16uOeZk1wT20x.dooy/pMTUZn0FjBZCI.yxJHpp2HbjQe', '0', NULL, '321214', 'officer', NULL, 'rejected', '2025-10-04 03:53:29', 'josemarichan@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('avina', '$2y$10$ys1a63YOm1/oqj6QvsJe/eRpdP.oLLqMYZKHbXn/kCYZcOavQy/ku', '0', NULL, '321215', 'officer', NULL, 'pending', '2025-10-14 01:40:17', 'avina@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('Alexa', '$2y$10$02SlnXsbCGRHo.Ylr6RGaeqyy4iO.JoL6iYFtzgRgLBbFgfJAWf.q', '0', NULL, '321216', 'admin', NULL, 'approved', '2025-10-14 01:42:16', 'alexa@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('admin', '$2y$10$T1cQRA8Y2SqmVCfXM08dF.u.DFPWWu75Cbu0tF5Q86n1mtCQOQA4O', '0', NULL, '321219', 'admin', NULL, 'approved', '2025-10-17 23:31:04', 'admin@gmail.com', '09876543456', 'Female', 'Sitio Bukid, Calapacuan Subic Zambales', '1760859106_photo_2024-08-13_09-05-00.jpg', 'Jovelyn', 'San Jose', NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('klare', '$2y$10$9VF71TBuQ6AKfWYdEHw7yeO0JTD6thouGWbqC0HhVcIq1WVGN2Dj.', '0', NULL, '321220', 'admin', NULL, 'approved', '2025-10-18 00:41:30', 'kaliegoalthea@gmail.com', '09620433464', 'Female', 'Calapacuan', '1770819859_knscsd2526-a11baf2f-4450-4b71-8f7c-a3d1776be7cd.jpg', 'Klare desteen', 'Montefalco', NULL, '1', '49357f9a38d45612536717d9aea408f06feaf6ed2219f0fe2728c4cf4cb53a32', '2026-03-13 22:05:28');
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('John', '$2y$10$hTbYydbNq/9embkicVkbHO/8uA3g.MsCL3CdgpL24mzzQ2fTxp2fi', '0', NULL, '321221', 'admin', NULL, 'approved', '2025-11-29 23:11:15', 'johncarlmangino2@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('kim', '$2y$10$Z.kcTA4TWDbusbBPru7Vxu2Rsrh4ipEK4RuQrTiU7lf50wHI88ija', '0', NULL, '321222', 'officer', NULL, 'approved', '2025-11-29 23:11:48', 'kim@gmail.com', '095678434', 'Female', 'San Marcelino', '1764573767_Screenshot 2025-02-28 124358.png', 'Kimberly', 'Mangino', NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('officer', '$2y$10$9hXspEoAQUp9qwIqx7FWyuvx1/ROmn.vzyhEQlDoDRL9vryN8DoBy', '0', NULL, '321223', 'officer', 'secretary', 'approved', '2026-01-17 01:55:30', 'officers@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('katkat', '$2y$10$K60WieyP2Z6vtmw63DAwF..azLkSgKt2G9bRSCF/R4c4.OT.vrXb.', '0', NULL, '321224', 'officer', NULL, 'pending', '2026-02-08 19:00:23', 'altheakaliego@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('johncarl', '$2y$10$GA3I.H2dAHoL0cYc2S9afu49I00E09ZH9gi7957Iaw/NhhGqb6a/i', '0', NULL, '321225', 'officer', NULL, 'approved', '2026-02-12 01:06:37', 'johncarlmangino7@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('carl', '$2y$10$lRf/vTLIcxFRiO6xFIM6gOu8ZbQYASgk6xOxiLQuSLX8dM2yzQ2oG', '0', NULL, '321226', 'officer', NULL, 'approved', '2026-02-12 01:10:51', 'johncarlmangino17@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('argie', '$2y$10$DvGOiIvyJK./dyStHW92gOwgQTCY5sVWrRegA/8HFanhRW5/ZT8EC', '0', NULL, '321227', 'officer', NULL, 'approved', '2026-03-05 07:29:32', 'ARGIEPO3@GMAIL.COM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
INSERT INTO `users` (`username`, `password_hash`, `force_password_change`, `temp_password`, `id`, `role`, `transparency_role`, `status`, `created_at`, `email`, `mobile`, `gender`, `address`, `avatar`, `first_name`, `last_name`, `member_id`, `is_admin`, `reset_token_hash`, `reset_token_expires_at`) VALUES ('klare31', '$2y$10$MZA5KAySj.kODdv57zA14e4Ls.eVN3zXzTsyRvD3K7chIm9nBbm7.', '0', NULL, '321228', 'officer', NULL, 'pending', '2026-03-05 07:34:42', 'ARGIEPOa3@GMAIL.COM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, NULL);
